# Security Baseline: ai-chatbot-support

## Purpose

Define the minimum security and privacy review baseline for the `ai-chatbot-support` software class.
...
This profile covers conversational support assistant with escalation and service boundaries. The blueprint must map these controls to the actual raw request instead of assuming a market vertical.
