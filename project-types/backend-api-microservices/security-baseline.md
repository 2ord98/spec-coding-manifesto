# Security Baseline: backend-api-microservices

## Purpose

Define the minimum security and privacy review baseline for the `backend-api-microservices` software class.
...
This profile covers server-side API, integration service, or distributed backend system. The blueprint must map these controls to the actual raw request instead of assuming a market vertical.
