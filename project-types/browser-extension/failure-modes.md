# Failure Modes: browser-extension

## Typical AI failure modes

- overbroad permissions
- content script scope too wide
- privacy boundary unclear
- browser compatibility untested
- background behavior not visible to users

## Detection signals

- Artifact uses generic product structure instead of the browser augmentation and extension class.
