# Security Baseline: browser-extension

## Purpose

Define the minimum security and privacy review baseline for the `browser-extension` software class.
...
This profile covers browser extension or web augmentation layer with permission constraints. The blueprint must map these controls to the actual raw request instead of assuming a market vertical.
