# Failure Modes: content-generation-studio

## Typical AI failure modes

- generic output style
- missing editorial approval path
- asset rights and source tracking omitted
- no revision history
- publishing target assumed too early

## Detection signals

- Artifact uses generic product structure instead of the content production, review, and publishing workflow class.
