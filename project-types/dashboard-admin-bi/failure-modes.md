# Failure Modes: dashboard-admin-bi

## Typical AI failure modes

- vanity metrics instead of decisions
- unclear role visibility rules
- charts without source or refresh semantics
- bulk actions without confirmation gates
- no export or audit boundary

## Detection signals

- Artifact uses generic product structure instead of the operational dashboard, admin surface, and reporting class.
