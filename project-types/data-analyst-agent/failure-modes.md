# Failure Modes: data-analyst-agent

## Typical AI failure modes

- unverified calculations
- ambiguous data source selection
- query generation without safety limits
- charts without method notes
- no distinction between facts and assumptions

## Detection signals

- Artifact uses generic product structure instead of the analysis assistant and query workflow class.
