# Security Baseline: data-analyst-agent

## Purpose

Define the minimum security and privacy review baseline for the `data-analyst-agent` software class.
...
This profile covers analysis assistant over datasets, metrics, and queryable business data. The blueprint must map these controls to the actual raw request instead of assuming a market vertical.
