# Security Baseline: desktop-app

## Purpose

Define the minimum security and privacy review baseline for the `desktop-app` software class.
...
This profile covers desktop application with local OS integration and offline behavior. The blueprint must map these controls to the actual raw request instead of assuming a market vertical.
