# Failure Modes: document-ai-extraction

## Typical AI failure modes

- single-pass extraction without confidence
- no human review threshold
- untracked source files
- schema changes without migration plan
- retention and deletion behavior omitted

## Detection signals

- Artifact uses generic product structure instead of the document ingestion, extraction, classification, and review class.
