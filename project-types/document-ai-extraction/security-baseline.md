# Security Baseline: document-ai-extraction

## Purpose

Define the minimum security and privacy review baseline for the `document-ai-extraction` software class.
...
This profile covers document ingestion, extraction, classification, and review workflow. The blueprint must map these controls to the actual raw request instead of assuming a market vertical.
