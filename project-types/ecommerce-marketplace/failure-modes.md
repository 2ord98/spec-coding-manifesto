# Failure Modes: ecommerce-marketplace

## Typical AI failure modes

- cart or checkout behavior assumed without request evidence
- inventory and state transitions left informal
- payment workflow added before approval
- trust and dispute states omitted
- generic catalog UI without operational rules

## Detection signals

- Artifact uses generic product structure instead of the transactional catalog, booking, or exchange workflow class.
