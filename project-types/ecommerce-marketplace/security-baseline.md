# Security Baseline: ecommerce-marketplace

## Purpose

Define the minimum security and privacy review baseline for the `ecommerce-marketplace` software class.
...
This profile covers catalog, transaction, booking, or multi-party commerce workflow. The blueprint must map these controls to the actual raw request instead of assuming a market vertical.
