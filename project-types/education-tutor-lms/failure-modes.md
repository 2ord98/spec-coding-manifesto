# Failure Modes: education-tutor-lms

## Typical AI failure modes

- one-size-fits-all learning path
- assessment validity ignored
- progress model left implicit
- content provenance not tracked
- accessibility and learner support omitted

## Detection signals

- Artifact uses generic product structure instead of the learning workflow, tutor, assessment, or course delivery class.
