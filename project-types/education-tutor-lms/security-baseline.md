# Security Baseline: education-tutor-lms

## Purpose

Define the minimum security and privacy review baseline for the `education-tutor-lms` software class.
...
This profile covers learning workflow, tutoring assistant, course platform, or assessment system. The blueprint must map these controls to the actual raw request instead of assuming a market vertical.
