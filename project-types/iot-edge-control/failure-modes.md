# Failure Modes: iot-edge-control

## Typical AI failure modes

- unsafe control loop defaults
- telemetry without bounds
- network outage behavior missing
- firmware/device capability assumed
- manual override omitted

## Detection signals

- Artifact uses generic product structure instead of the edge, device control, telemetry, or local automation class.
