# Security Baseline: iot-edge-control

## Purpose

Define the minimum security and privacy review baseline for the `iot-edge-control` software class.
...
This profile covers device, edge, sensor, or control system with physical-world constraints. The blueprint must map these controls to the actual raw request instead of assuming a market vertical.
