# Failure Modes: marketing-site-cms

## Typical AI failure modes

- heavy application architecture for mostly static content
- authentication or database added by habit
- generic landing page with no content model
- unclear form handling and privacy notice
- missing accessibility and navigation smoke checks

## Detection signals

- Artifact uses generic product structure instead of the public content, conversion, and CMS site.
