# Security Baseline: marketing-site-cms

## Purpose

Define the minimum security and privacy review baseline for the `marketing-site-cms` software class.
...
This profile covers public content, conversion, documentation, or lightweight CMS surface. The blueprint must map these controls to the actual raw request instead of assuming a market vertical.
