# Security Baseline: mobile-app

## Purpose

Define the minimum security and privacy review baseline for the `mobile-app` software class.
...
This profile covers mobile-first product with device constraints, app lifecycle, and network variability. The blueprint must map these controls to the actual raw request instead of assuming a market vertical.
