# Failure Modes: multi-agent-control-system

## Typical AI failure modes

- agents act without approval gates
- unclear ownership of final decisions
- no audit trail for tool calls
- loops without termination rules
- role boundaries overlap silently

## Detection signals

- Artifact uses generic product structure instead of the coordinated agent workflow and control tower class.
