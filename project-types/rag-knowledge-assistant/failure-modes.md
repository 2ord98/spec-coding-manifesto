# Failure Modes: rag-knowledge-assistant

## Typical AI failure modes

- uncited answers
- stale or untracked corpus
- out-of-corpus answer instead of refusal
- document access boundaries ignored
- no freshness or grounding tests

## Detection signals

- Artifact uses generic product structure instead of the retrieval-grounded assistant class.
