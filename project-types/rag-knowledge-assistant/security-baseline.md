# Security Baseline: rag-knowledge-assistant

## Purpose

Define the minimum security and privacy review baseline for the `rag-knowledge-assistant` software class.
...
This profile covers retrieval-grounded assistant over controlled knowledge sources. The blueprint must map these controls to the actual raw request instead of assuming a market vertical.
