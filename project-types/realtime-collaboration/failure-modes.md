# Failure Modes: realtime-collaboration

## Typical AI failure modes

- conflict resolution omitted
- presence state treated as truth
- offline reconnect behavior missing
- permissions unclear in shared spaces
- latency budget absent

## Detection signals

- Artifact uses generic product structure instead of the shared state, chat, editor, or collaboration class.
