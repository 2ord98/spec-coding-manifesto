# Security Baseline: realtime-collaboration

## Purpose

Define the minimum security and privacy review baseline for the `realtime-collaboration` software class.
...
This profile covers realtime collaboration, messaging, shared editing, or synchronized workspace. The blueprint must map these controls to the actual raw request instead of assuming a market vertical.
