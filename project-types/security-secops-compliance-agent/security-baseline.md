# Security Baseline: security-secops-compliance-agent

## Purpose

Define the minimum security and privacy review baseline for the `security-secops-compliance-agent` software class.
...
This profile covers security, operations, compliance, audit, or risk workflow assistant. The blueprint must map these controls to the actual raw request instead of assuming a market vertical.
