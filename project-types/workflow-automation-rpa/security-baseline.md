# Security Baseline: workflow-automation-rpa

## Purpose

Define the minimum security and privacy review baseline for the `workflow-automation-rpa` software class.
...
This profile covers automation workflow across tools, approvals, and repetitive operations. The blueprint must map these controls to the actual raw request instead of assuming a market vertical.
